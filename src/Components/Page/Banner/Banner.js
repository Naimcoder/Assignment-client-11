...
const Banner = () => {
    return (
        <div className='flex mx-auto w-8/12 items-center'>
            <div className='w-1/2 py-20'>
                <h1 className='text-6xl font-semibold'>The Best <br/> Restaurants  <br/>In  Your <br/>Home</h1>
                <p className='py-5 font-normal'>Imagine devouring delicious, healthy meals daily without so much as lifting a pot for your every day life.</p>
